...
class ConfigSettingAdapter extends TypeAdapter<ConfigSetting> {
  ...
  ConfigSetting read(BinaryReader reader) {
    ...
    return ConfigSetting()
      ...
      ..column1Height = fields[14] as int
      ..column2Height = fields[15] as int
      ...
      ..propertyNamingConventionsType = fields[7] as PropertyNamingConventionsType
  ...
  void write(BinaryWriter writer, ConfigSetting obj) {
    writer
      ...
      ..writeByte(14)
      ..write(obj.column1Height)
      ..writeByte(15)
      ..write(obj.column2Height)
      ..writeByte(3)
  ...
  bool operator ==(Object other) =>
      ...
      other is ConfigSettingAdapter && runtimeType == other.runtimeType && typeId == other.typeId;
}
