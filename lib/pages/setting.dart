...
class _MoreSettingState extends State<MoreSetting> {
  ...
  Widget build(BuildContext context) {
    ...
    final Wrap buttonGroup = Wrap(
      ...
      children: <Widget>[
        /*StCheckBox(
          title: appLocalizations.dataProtection,//数据保护
        ...
        /* StCheckBox(
          title: appLocalizations.arrayProtection,//数组保护
        ...
        StPicker(
          title: appLocalizations.nameRule, //名字规则
          child: DropdownButton<PropertyNamingConventionsType>(
            iconEnabledColor: ColorPlate.blue,
            value: ConfigSetting().propertyNamingConventionsType, //小驼峰
        ...
        /*StCheckBox(
          title: appLocalizations.addMethod,//添加保护方法
        ...
        /*StCheckBox(
          title: appLocalizations.nullsafety, //空安全
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: TextField(
              maxLines: null,
              controller: TextEditingController()..text = ConfigSetting().fileHeaderInfo,
