      ...
      child: finalDepth > 0 && !widget.isArrayOject
          ? Container(
              ...
              child: Selector<ConfigSetting, PropertyAccessorType>(
                builder: (BuildContext c, PropertyAccessorType value, Widget? child) {
                  property.propertyAccessorType = value;
                  return PropertyAccessorTypeDropdownButton(property);
                },
                selector: (BuildContext c, ConfigSetting vm) => vm.propertyAccessorType,
              ),
            )
          : Container(
              color: ColorPlate.borderGray,
      ...
      children: <Widget>[
        Container(
          ...
          child: Icon(
            Icons.label,
            size: SysSize.normal,
            color: isNullOrWhiteSpace(widget.property.className) ? Colors.red : Colors.blue,
          ),
        ),
        Expanded(
          child: TextField(
            ...
            controller: TextEditingController()..text = widget.property.className,
    ...
    return Container(
      ...
      child: TextField(
        ...
        onChanged: (String value) {
          ...
          if (value != oldValue && (isNullOrWhiteSpace(value) || isNullOrWhiteSpace(oldValue))) {
            setState(() {});
          }
        },
      ),
...
class _PropertyAccessorTypeDropdownButtonState extends State<PropertyAccessorTypeDropdownButton> {
  @override
  Widget build(BuildContext context) {
    return DropdownButton<PropertyAccessorType>(
        ...
        items: PropertyAccessorType.values
            ...
            .map<DropdownMenuItem<PropertyAccessorType>>(
                (PropertyAccessorType f) => DropdownMenuItem<PropertyAccessorType>(
                      value: f,
                      child: Text(f
                          .toString()
...
class _DartTypeDropdownButtonState extends State<DartTypeDropdownButton> {
  ...
  Widget build(BuildContext context) {
    return DropdownButton<DartType>(
      ...
      underline: Container(),
      value: widget.property.type == DartType.Null ? DartType.Object : widget.property.type,
